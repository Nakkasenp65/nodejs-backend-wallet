 ...
 * @param {object} res - อ็อบเจกต์ Express Response
 */
const searchRecipient = catchAsync(async (req: Request, res: Response) => {
    const { type, value } = req.query;
    // @ts-ignore: query params are strings, service expects string
 ...
 * @param {object} res - อ็อบเจกต์ Express Response
 */
const setLocked = catchAsync(async (req: Request, res: Response) => {
    const { line_user_id } = req.params;
 ...
 * @param {object} res - อ็อบเจกต์ Express Response
 */
const unlock = catchAsync(async (req: Request, res: Response) => {
