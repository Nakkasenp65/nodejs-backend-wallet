...
export const sendRegisterFlexMessage = (line_user_id: string, payload: any) => {
    return flexMessage("register", line_user_id, payload);
};
...
export const sendDepositFlexMessage = (line_user_id: string, payload: any) => {
    return flexMessage("save", line_user_id, payload);
};
...
export const sendWithdrawSuccessFlex = (
    ...
    return flexMessage("withdraw", line_user_id, payload);
};
...
export const sendTransferReceivedFlex = (
    ...
    const payload = { senderWalletUniqueId, receiverWalletUniqueId, liffUrlHistory, formattedAmount, formattedDate, formattedBalance };
    return flexMessage("receiver", line_user_id, payload);
};
...
export const sendTransferSentFlex = (
    ...
    const payload = { senderWalletUniqueId,receiverWalletUniqueId, liffUrlHistory, formattedAmount, formattedDate, formattedBalance };
    return flexMessage("sender", line_user_id, payload);
};
...
export const flexMessage = (mode: string | null = null, line_user_id: string, payload: any = {}) => {
    ...
    if (mode === "receiver") {
        ...
        if (
            ...
            throw new ApiError(httpStatus.BAD_REQUEST, "Flex data insufficient");
        return {
