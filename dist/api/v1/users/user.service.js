...
const createUserWithGoal = async (userData) => {
    const { mobileId, planId, line_user_id, line_display_name, line_profile_url, email, occupation, ageRange, monthlyPayment, fullname, chat_url, phone, pin, referToCode, } = userData;
