 ...
 * @param {object} res - อ็อบเจกต์ Express Response
 */
const getAllMissionsForAdmin = catchAsync(async (req: Request, res: Response) => {
 ...
 * @param {object} res - อ็อบเจกต์ Express Response
 */
const getAvailableMissions = catchAsync(async (req: Request, res: Response) => {
 ...
 * @param {object} res - อ็อบเจกต์ Express Response
 */
const getMissionDetails = catchAsync(async (req: Request, res: Response) => {
    const { missionId } = req.params;
