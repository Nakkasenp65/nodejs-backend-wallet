...
import { TransactionStatus, TransactionType, Prisma } from "../../../generated/prisma/index";
 ...
 */
const createSavingTransaction = async (transactionBody: any, imageUrl: string) => {
 ...
 */
const createWithdrawTransaction = async (userId: string, amount: number | string, withdrawalDetails: any) => {
 ...
 */
const createInternalTransfer = async (senderUserId: string, transferData: any) => {
 ...
 */
const getWalletTransaction = async (walletId: string, options: any = {}) => {
...
const getSuccessTransaction = async (walletId: string, options: any = {}) => {
    const whereClause: any = {
        status: "SUCCESS",
        OR: [{ fromWalletId: walletId }, { toWalletId: walletId }],
    };
 ...
 */
const getTransactions = async (options: any = {}) => {
 ...
 */
const handleApproval = async (transactionId: string, existingTransaction: any, dataToUpdate: any) => {
 ...
 * @returns {Promise<object>} Promise ที่ resolve เป็นอ็อบเจกต์ธุรกรรมที่อัปเดตแล้ว
 */
const editTransaction = async (transactionId: string, file: any, payload: any) => {
    if (!transactionId) {
 ...
 */
const approveDeposit = async (transactionId: string, approvalData: any) => {
 ...
 */
const rejectDeposit = async (transactionId: string, rejectionData: any) => {
